...
import xyz.esuku.startupingnitex.Controller.GrantActivity;
import xyz.esuku.startupingnitex.Controller.MainActivity;
import xyz.esuku.startupingnitex.Controller.SignUpActivity;
...
public class AspiringEntraprenuar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aspiring_entraprenuar);
        userDb_helper   = new UserDb_Helper(AspiringEntraprenuar.this);
        myProgressDialog    = new MyProgressDialog(AspiringEntraprenuar.this);
        ...
        aspire_business_name_text           = findViewById(R.id.aspire_business_name_text);
        businessName_error                  = findViewById(R.id.businessName_error);

        expertise_text                      = findViewById(R.id.expertise_text);
        expertise_error                     = findViewById(R.id.expertise_error);
        ...
        week_to_start_error                 = findViewById(R.id.week_to_start_error);

        previous_experience_text            = findViewById(R.id.previous_experience_text);
        previous_experience_error           = findViewById(R.id.previous_experience_error);
        ...
        back_btn.setOnClickListener(v -> {
            Intent intent = new Intent(AspiringEntraprenuar.this, MainActivity.class);
        ...
        interest_spinner.setOnSpinnerItemSelectedListener((parent, view, position, id) -> {
            ...
            if(item.equals("Select")){
                ...
                Toast.makeText(AspiringEntraprenuar.this, "Selected value not accepted", Toast.LENGTH_LONG).show();
            }
        ...
        Save.setOnClickListener(v -> {
            ...
            String bussines_name         = aspire_business_name_text.getText().toString().trim();
            if(bussines_name.isEmpty() || bussines_name.equals("")){
                businessName_error.setVisibility(View.VISIBLE);
            }
            if(!bussines_name.isEmpty()){
                businessName_error.setVisibility(View.GONE);
            }

            String expertise         = expertise_text.getText().toString().trim();
            if(expertise.isEmpty() || expertise.equals("")){
                expertise_error.setVisibility(View.VISIBLE);
            }
            if(!expertise.isEmpty()){
                expertise_error.setVisibility(View.GONE);
            }
            ...
            String week_to_start         = week_to_start_text.getText().toString().trim();
            if(week_to_start.isEmpty() || week_to_start.equals("")){
                week_to_start_error.setVisibility(View.VISIBLE);
            }
            if(!week_to_start.isEmpty()){
                week_to_start_error.setVisibility(View.GONE);
            }

            String previous_exp         = previous_experience_text.getText().toString().trim();
            if(previous_exp.isEmpty() || previous_exp.equals("")){
                previous_experience_error.setVisibility(View.VISIBLE);
            }
            if(!previous_exp.isEmpty()){
                previous_experience_error.setVisibility(View.GONE);
            }
    ...
    private void update_profile_setting(String bussines_name, String expertise, String interest, String week_to_start, String previous_exp, String email, String phone,
                                        String full_name, String city, String mentor) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, requestUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status.equals("fail")){
                        ...
                        final AlertDialog.Builder alertDialg  = new AlertDialog.Builder(AspiringEntraprenuar.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                postMap.put("expertise", expertise);
                postMap.put("interest", interest);
                postMap.put("week_to_start", week_to_start);
                postMap.put("previous_exp", previous_exp);
